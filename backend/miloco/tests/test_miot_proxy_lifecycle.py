...
def _make_client_stub():
    ...
    c.register_device_meta_changed_callback = MagicMock()
    c.register_device_state_changed_callback = MagicMock()
    c.register_device_event_callback = MagicMock()
    c.register_scene_changed_callback = MagicMock()
